...
/**
 * @file
 * @brief Wa-Tor simulation working in parallel using SFML and OpenMP.
 * @author Marcel Zama C00260146
 * @date 27/11/2023
 * @title Wa-Tor simulation working Parallel
 * @github https://github.com/MarcelZama/Wa-Tor-Problem/tree/main
 */
...
const int Threads = 16;      // Number of OpenMP threads
...
/**
 * @brief Function to initialize the grid with fish and sharks.
...
/**
 * @brief Function to swap two cells in the grid.
 * @param cell1 First cell to swap.
 * @param cell2 Second cell to swap.
 */
...
/**
 * @brief Function to update the fish population in the grid.
 * @param grid Reference to the 2D grid.
 */
...
/**
 * @brief Function to update the shark population in the grid.
 * @param grid Reference to the 2D grid.
 */
...
/**
 * @brief Function to count the number of sharks in the grid.
 * @param grid Reference to the 2D grid.
 * @return Number of sharks in the grid.
 */
...
/**
 * @brief Function to count the number of fishes in the grid.
 * @param grid Reference to the 2D grid.
 * @return Number of fishes in the grid.
 */
...
/**
 * @brief Function to draw the grid using SFML.
 * @param window SFML window to draw on.
 * @param iteration Current iteration.
 * @param fishCount Number of fishes in the grid.
 * @param sharkCount Number of sharks in the grid.
 * @param durationin Duration of the update process in microseconds.
 * @param averagedurationin Average duration of the update process in microseconds.
 * @param grid Reference to the 2D grid.
 */
